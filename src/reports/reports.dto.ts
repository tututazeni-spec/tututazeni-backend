...
import {
  ...
  IsBoolean, IsDateString, IsEmail, Min, MaxLength,
...
export class CreateScheduleDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsArray() @IsEmail({}, { each: true }) recipients?: string[];
  @ApiPropertyOptional({ enum: ReportFormat, isArray: true })
  @IsOptional() @IsArray() @IsEnum(ReportFormat, { each: true }) formats?: ReportFormat[];
}
