  ...
  private getBuiltInTemplates() {
    return [
      ...
      },
      {
        ...
        category: 'LEARNING',
        reportKey: 'skill-gap',
        description: 'Lacunas de Competências Por Departamento',
      },
      {
        id: 'TPL_PERFORMANCE',
      ...
      },
      {
        ...
        category: 'TALENT',
        reportKey: 'talent',
        description: 'Talentos de Alto Potencial, PDI, sucessão e competências',
      },
      {
        id: 'TPL_ENGAGEMENT',
        ...
        description: 'Inquéritos, eNPS - Índice de Recomendação dos Colaboradores e participação',
      },
      {
        id: 'TPL_COMPLIANCE',
