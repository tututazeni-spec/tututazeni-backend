...
export class CreateProficiencyLevelDto {
  ...
  @ApiProperty({ description: 'Escala 1-5' })
  @IsInt()
  @Min(1)
  @Max(5)
  value!: number;
...
export class UpsertUserCompetencyDto {
  ...
  @ApiProperty({ description: 'Nível actual (1-5)' })
  @IsInt()
  @Min(1)
  @Max(5)
  currentLevel!: number;
...
export class MapCompetencyToPositionDto {
  ...
  @ApiProperty({ description: 'Nível requerido (1-5)' })
  @IsInt()
  @Min(1)
  @Max(5)
...
export class CreateEndorsementDto {
  @ApiProperty({ description: 'ID do utilizador endossado' })
  @IsInt()
  targetUserId!: number;
