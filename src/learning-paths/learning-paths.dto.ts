import {
  ...
  IsEnum, IsDateString, IsNumber, Min, Max, MaxLength, ValidateNested,
...
export class CreateLearningPathDto {
  ...
  @IsOptional() @IsEnum(LearningPathLevel)
  level?: LearningPathLevel;

  @ApiPropertyOptional({ enum: LearningPathType })
  @IsOptional() @IsEnum(LearningPathType)
  ...
  @IsOptional() @IsEnum(LearningPathStatus)
...
export class LearningPathFilterDto {
  ...
  @ApiPropertyOptional({ enum: LearningPathStatus }) @IsOptional() @IsEnum(LearningPathStatus)
  status?: LearningPathStatus;

  @ApiPropertyOptional({ enum: LearningPathLevel }) @IsOptional() @IsEnum(LearningPathLevel)
  level?: LearningPathLevel;

  @ApiPropertyOptional({ enum: LearningPathType }) @IsOptional() @IsEnum(LearningPathType)
  pathType?: LearningPathType;
