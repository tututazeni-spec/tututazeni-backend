...
export class CreateAvatarDto {
  ...
  @ApiPropertyOptional({ enum: AvatarStyle }) @IsOptional() @IsEnum(AvatarStyle) style?: AvatarStyle;
  @ApiPropertyOptional({ enum: AvatarPersonality }) @IsOptional() @IsEnum(AvatarPersonality) personality?: AvatarPersonality;
  ...
  @ApiPropertyOptional()  @IsOptional() @IsArray() @IsString({ each: true }) knowledgeUrls?: string[];
...
export class ScenarioTurnDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsArray() @IsString({ each: true }) expectedKeywords?: string[];
...
export class CreateScenarioDto {
  ...
  @IsOptional() @IsArray() @ValidateNested({ each: true }) @Type(() => ScenarioTurnDto) turns?: ScenarioTurnDto[];
}

export class ScenarioFilterDto {
  @ApiPropertyOptional({ enum: ScenarioCategory }) @IsOptional() @IsEnum(ScenarioCategory) category?: ScenarioCategory;
