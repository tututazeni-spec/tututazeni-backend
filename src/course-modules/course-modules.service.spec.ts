...
const mockPrisma = {
  ...
  lessonProgress: { findFirst: jest.fn(), upsert: jest.fn(), findMany: jest.fn().mockResolvedValue([]) },
  moduleMaterial: { create: jest.fn(), findMany: jest.fn().mockResolvedValue([]), delete: jest.fn() },
...
const baseMod = { id: 1, courseId: 1, title: 'Módulo 1', seq: 1, status: 'DRAFT', lessons: [], _count: { lessons: 3 } };
