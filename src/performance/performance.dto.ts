...
export class CreatePerformanceReviewDto {
  @ApiProperty({ description: 'ID do colaborador avaliado' })
  @IsInt()
  userId!: number;
...
export class GoalEvaluationDto {
  ...
  @ApiProperty({ description: 'Score do goal (0-100)' })
  @IsNumber()
  @Min(0)
  @Max(100)
  score!: number;
...
export class CompetencyEvaluationDto {
  ...
  @ApiProperty({ description: 'Nível avaliado (1-5)' })
  @IsInt()
  @Min(1)
  @Max(5)
...
export class CalibrateReviewDto {
  ...
  @ApiProperty({ description: 'Score calibrado' })
  @IsNumber()
  @Min(0)
  calibratedScore!: number;

  @ApiProperty({ description: 'Motivo da calibração' })
  @IsString()
  reason!: string;
...
export class Update9BoxDto {
  ...
  @ApiProperty({ description: 'Eixo Performance (1-3)' })
  @IsInt()
  @Min(1)
  @Max(3)
  performanceAxis!: number;

  @ApiProperty({ description: 'Eixo Potencial (1-3)' })
  @IsInt()
  @Min(1)
  @Max(3)
  potentialAxis!: number;

  @ApiProperty({ description: 'Justificativa' })
  @IsString()
  justification!: string;
