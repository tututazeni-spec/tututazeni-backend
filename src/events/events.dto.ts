...
import {
  IsString, IsOptional, IsInt, IsDateString, IsEnum,
  IsBoolean, IsArray, IsUrl, Min, Max, MaxLength,
...
export class CreateEventDto {
  ...
  @IsOptional() @IsEnum(EventModalidade)
...
export class UpdateEventDto extends PartialType(CreateEventDto) {
  @ApiPropertyOptional({ enum: EventStatus }) @IsOptional() @IsEnum(EventStatus)
  status?: EventStatus;
}
...
export class CheckInDto {
  @ApiProperty({ description: 'ID do evento' }) @IsInt()
  eventId!: number;
...
export class SubmitFeedbackDto {
  @ApiProperty({ description: 'NPS 1-10' }) @IsInt() @Min(1) @Max(10)
  nps!: number;
...
export class EventFilterDto {
  ...
  @ApiPropertyOptional({ enum: EventType }) @IsOptional() @IsEnum(EventType)
  type?: EventType;

  @ApiPropertyOptional({ enum: EventModalidade }) @IsOptional() @IsEnum(EventModalidade)
  modalidade?: EventModalidade;
