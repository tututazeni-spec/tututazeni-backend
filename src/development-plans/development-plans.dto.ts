...
export class CreateDevelopmentPlanDto {
  ...
  @IsOptional() @IsEnum(PlanPriority)
...
export class CreatePlanActionDto {
  ...
  @ApiProperty({ enum: ActionType }) @IsEnum(ActionType)
  type!: ActionType;
...
export class ApprovePlanDto {
  ...
  @ApiProperty({ enum: ApprovalDecision }) @IsEnum(ApprovalDecision)
...
export class DevelopmentPlanFilterDto {
  ...
  @ApiPropertyOptional({ enum: PlanPriority }) @IsOptional() @IsEnum(PlanPriority)
  priority?: PlanPriority;
