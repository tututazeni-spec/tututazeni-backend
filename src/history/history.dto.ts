...
export class HistoryFilterDto {
  ...
  @ApiPropertyOptional({ enum: EventCategory }) @IsOptional() @IsEnum(EventCategory) category?: EventCategory;
  @ApiPropertyOptional({ enum: EventModule })   @IsOptional() @IsEnum(EventModule)   module?: EventModule;
