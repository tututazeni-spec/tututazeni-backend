...
export class CreateSurveyDto {
  ...
  @ApiPropertyOptional()  @IsOptional() @IsArray() @IsInt({ each: true }) targetDepartmentIds?: number[];
...
export class SubmitSurveyDto {
  ...
  @IsArray() @ValidateNested({ each: true }) @Type(() => SurveyAnswerDto) answers!: SurveyAnswerDto[];
...
export class FeedbackFilterDto {
  @ApiPropertyOptional({ enum: FeedbackType }) @IsOptional() @IsEnum(FeedbackType) type?: FeedbackType;
...
export class UpdateActionPlanDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() description?: string;
  @ApiPropertyOptional({ enum: ActionPlanStatus }) @IsOptional() @IsEnum(ActionPlanStatus) status?: ActionPlanStatus;
