...
export class CareerPlansController {
  ...
  @ApiQuery({ name: 'department', required: false })
  getRoles(@Query('department') department?: string) { return this.svc.getRoles(department); }
 
  @Get('roles/:id')
  @ApiOperation({ summary: 'Detalhe do cargo (skills, regras de progressão)' })
  getRole(@Param('id', ParseIntPipe) id: number) { return this.svc.getRole(id); }
  ...
  setRoleSkills(@Body() dto: SetRoleSkillsDto) { return this.svc.setRoleSkills(dto); }
  ...
  getSkills(@Query('type') type?: string) { return this.svc.getSkills(type); }
 
  @Post('skills')
  @Roles('ADMIN', 'RH')
  @ApiOperation({ summary: 'Criar skill/competência' })
  createSkill(@Body() dto: CreateSkillDto) { return this.svc.createSkill(dto); }
  ...
  @ApiQuery({ name: 'department', required: false })
  getCareerPaths(@Query('department') department?: string) { return this.svc.getCareerPaths(department); }
  ...
  simulate(@Body() dto: SimulateCareerDto) { return this.svc.simulateCareer(dto); }
  ...
  getProgress(@Param('id', ParseIntPipe) id: number) { return this.svc.getProgress(id); }
  ...
  getPromotions(@Query() filters: PromotionFilterDto) { return this.svc.getPromotions(filters); }
