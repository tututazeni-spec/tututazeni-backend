...
// ─── Built-in permission matrix + role defaults ──────────────────
// Movidos para src/roles-permissions/role-defaults.ts na Fase D — re-exportados
// aqui enquanto este ficheiro existir (eliminado na Task 7 da mesma fase).
import { BUILTIN_PERMISSIONS, ROLE_DEFAULTS } from '../roles-permissions/role-defaults';

export { BUILTIN_PERMISSIONS };
