/*
  ...
  - You are about to drop the column `isActive` on the `Competency` table. All the data in the column will be lost.
  - You are about to drop the column `isGlobal` on the `Competency` table. All the data in the column will be lost.
  - You are about to drop the column `scaleMax` on the `Competency` table. All the data in the column will be lost.
  - You are about to drop the column `scaleMin` on the `Competency` table. All the data in the column will be lost.
  - You are about to drop the column `tenantId` on the `Competency` table. All the data in the column will be lost.
  - You are about to drop the column `type` on the `Competency` table. All the data in the column will be lost.
  - You are about to drop the `CompetencyIndicator` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "CompetencyIndicator" DROP CONSTRAINT "CompetencyIndicator_competencyId_fkey";

-- DropIndex
DROP INDEX "Competency_isActive_idx";

-- AlterTable
ALTER TABLE "Competency" DROP COLUMN "isActive",
...
-- DropTable
DROP TABLE "CompetencyIndicator";
